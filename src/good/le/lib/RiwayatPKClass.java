...
public class RiwayatPKClass {
	int id;
	String id_kandidat,ringkasan,tahun_mulai,tahun_selesai;
	
	public RiwayatPKClass(){
		
	}
	
	public RiwayatPKClass(int id,String id_kandidat,String ringkasan,String tahun_mulai,String tahun_selesai){
		this.id = id;
	...
	public RiwayatPKClass(String id_kandidat,String ringkasan,String tahun_mulai,String tahun_selesai){
		this.id_kandidat = id_kandidat;
		this.ringkasan = ringkasan;
		this.tahun_mulai = tahun_mulai;
		this.tahun_selesai = tahun_selesai;
